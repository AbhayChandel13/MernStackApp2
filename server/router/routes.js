...
const {login,getUsers, createUser,createEmployee,deleteUser, logout,getdata, getRoles, getEmployee,assignProject,createProject,getProjects,getassignedprojects,deleteEmployee} = require("../controller/criteria");
